...
async def provide_user_service(
    ...
    redis: Redis = Provide(provide_redis_client),
) -> UserService:
    return UserService(user_repository, redis_client=redis)

async def provide_product_service(
    product_repository: ProductRepository = Provide(provide_product_repository),
    redis: Redis = Provide(provide_redis_client),
) -> ProductService:
    return ProductService(product_repository, redis_client=redis)
